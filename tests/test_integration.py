...
def test_dict_with_schema_and_keys():
    ...
    @guard(
        config={
            "keys": ["database", "cache"],
            "schema": {"database": dict, "cache": dict}
        }
    )
...
def test_many_arguments_validation():
    ...
    @guard(
        ...
        d={"gte": 0}, e={"gte": 0}, f={"gte": 0},
        g={"gte": 0}, h={"gte": 0}, i={"gte": 0},
        j={"gte": 0}
    )
